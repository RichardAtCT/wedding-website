...
$(document).ready(function () {
  ...
  function populateInvitation() {
    ...
    $('#invitation p').html(`The dates are ${dates} and we would like you to be a part of it.`);
  }
  ...
  function populateVenue() {
    ...
    if (data.venue.contact) {
      const phoneHtml = data.venue.contact.phones
        .map((phone, index) => {
  ...
  function populateRSVP() {
    ...
    $('#rsvp p')
      .first()
      .html(`We would greatly appreciate if you could RSVP by ${data.rsvp.deadline}`);
  }
  ...
  function updateImages() {
    // Update logo
    $('.logo img')
      .attr('src', data.images.logo)
      .attr('alt', data.couple.coupleNames + ' Wedding Logo');
