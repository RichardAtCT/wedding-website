...
(function (r, G, f, v) {
  ...
  f.extend(b, {
    ...
    showLoading: function () {
      ...
      b.defaults.fixed ||
        ((d = b.getViewport()),
        a.css({ position: 'absolute', top: 0.5 * d.h + d.y, left: 0.5 * d.w + d.x }));
    },
    ...
    isImage: function (a) {
      return (
        q(a) && a.match(/(^data:image\/.*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg)((\?|#).*)?$)/i)
      );
    },
    isSWF: function (a) {
                ...
                : t(e) &&
                  (e.data('fancybox-placeholder') ||
                    e.data(
                      ...
                      f('<div class="fancybox-placeholder"></div>').insertAfter(e).hide()
                    ),
                  (e = e.show().detach()),
    ...
    _setDimension: function () {
      ...
      if (h.fitToView)
        if (
          (g.width(c).height(j), e.width(c + x), (a = e.width()), (y = e.height()), h.aspectRatio)
        )
  ...
  b.transitions = {
    ...
    changeIn: function () {
      ...
      'none' === d
        ...
        : b.wrap
            .css(e)
            .animate(c, { duration: a.nextSpeed, easing: a.nextEasing, complete: b._afterZoomIn });
    },
    changeOut: function () {
      const a = b.previous,
        d = a.prevEffect,
  ...
  b.helpers.overlay = {
    ...
    onReady: function (a, b) {
      ...
      a.locked &&
        ...
        (e ||
          (this.margin =
            p.height() > n.height() ? f('html').css('margin-right').replace('px', '') : !1),
  ...
  p.ready(function () {
    ...
    if (f.support.fixedPosition === v) {
      ...
      const e = 20 === d[0].offsetTop || 15 === d[0].offsetTop;
      d.remove();
      a.fixedPosition = e;
    }
    f.extend(b.defaults, {
