    ...
    ($.data(e, 'flexslider', a),
      (m = {
        init: function () {
          ((a.animating = !1),
            ...
            '' !== a.vars.controlsContainer &&
              (a.controlsContainer =
                $(a.vars.controlsContainer).length > 0 && $(a.vars.controlsContainer)),
            '' !== a.vars.manualControls &&
              (a.manualControls = $(a.vars.manualControls).length > 0 && $(a.vars.manualControls)),
            '' !== a.vars.customDirectionNav &&
              (a.customDirectionNav =
                2 === $(a.vars.customDirectionNav).length && $(a.vars.customDirectionNav)),
            a.vars.randomize &&
            ...
            a.vars.keyboard &&
              ...
              $(document).bind('keyup', function (e) {
                ...
                if (!a.animating && (39 === t || 37 === t)) {
                  const n = 39 === t ? a.getTarget('next') : 37 === t ? a.getTarget('prev') : !1;
            ...
            a.vars.mousewheel &&
              a.bind('mousewheel', function (e, t, n, i) {
                e.preventDefault();
                const s = a.getTarget(0 > t ? 'next' : 'prev');
        ...
        controlNav: {
          ...
          setupPaging: function () {
            let e = 'thumbnails' === a.vars.controlNav ? 'control-thumbs' : 'control-paging',
              t = 1,
              i,
              s;
            if (
              ((a.controlNavScaffold = $('<ol class="' + n + 'control-nav ' + n + e + '"></ol>')),
              a.pagingCount > 1)
            )
              for (let l = 0; l < a.pagingCount; l++) {
                if (
                  ((s = a.slides.eq(l)),
                  (i =
                  ...
                  const c = s.attr('data-thumbcaption');
                  '' !== c &&
                    void 0 !== c &&
          ...
          set: function () {
            const e = 'thumbnails' === a.vars.controlNav ? 'img' : 'a';
            a.controlNav = $(
              '.' + n + 'control-nav li ' + e,
          ...
          update: function (e, t) {
            (a.pagingCount > 1 && 'add' === e
              ? a.controlNavScaffold.append($('<li><a>' + a.count + '</a></li>'))
              : 1 === a.pagingCount
            ...
            (a.customDirectionNav
              ...
              : a.controlsContainer
                ? ($(a.controlsContainer).append(e),
                  (a.directionNav = $('.' + n + 'direction-nav li a', a.controlsContainer)))
              ...
              a.directionNav.bind(r, function (e) {
                ...
                let t;
                (('' === o || o === e.type) &&
                  ((t = a.getTarget($(this).hasClass(n + 'next') ? 'next' : 'prev')),
        ...
        pausePlay: {
          setup: function () {
            const e = $('<div class="' + n + 'pauseplay"><a></a></div>');
            (a.controlsContainer
              ? (a.controlsContainer.append(e),
        ...
        touch: function () {
          ...
          function n(t) {
            t.stopPropagation();
            const a = t.target._slider;
            if (a) {
              const n = -t.translationX,
                i = -t.translationY;
              return (
                (w += c ? i : n),
                (m = w),
                  ...
                  : void (
                      ...
                      !v &&
                        ...
                        (a.vars.animationLoop ||
                          (m =
                            w /
                            ((0 === a.currentSlide && 0 > w) || (a.currentSlide === a.last && w > 0)
                              ? Math.abs(w) / p + 2
                              : 1)),
          ...
          function s(e) {
            e.stopPropagation();
            const t = e.target._slider;
            if (t) {
              if (t.animatingTo === t.currentSlide && !y && null !== m) {
                const a = d ? -m : m,
                  n = t.getTarget(a > 0 ? 'next' : 'prev');
                t.canAdvance(n) &&
                ((Number(new Date()) - f < 550 && Math.abs(a) > 50) || Math.abs(a) > p / 2)
            ...
            : ((g = function (t) {
              ...
              (h = function (e) {
                ...
                (!y || Number(new Date()) - f > t) &&
                  ...
                  !v &&
                    ...
                    (a.vars.animationLoop ||
                      (m /=
                        (0 === a.currentSlide && 0 > m) || (a.currentSlide === a.last && m > 0)
                          ? Math.abs(m) / p + 2
                          : 1),
                    a.setProps(l + m, 'setTouch')));
              }),
              (S = function (t) {
                if (
                  ...
                  a.canAdvance(i) &&
                  ((Number(new Date()) - f < 550 && Math.abs(n) > 50) || Math.abs(n) > p / 2)
                    ? a.flexAnimate(i, a.vars.pauseOnAction)
        ...
        sync: function (e) {
          const t = $(a.vars.sync).data('flexslider'),
            n = a.animatingTo;
          switch (e) {
            case 'animate':
        ...
        pauseInvisible: {
          visProp: null,
          init: function () {
            const e = m.pauseInvisible.getHiddenProp();
            if (e) {
              const t = e.replace(/[H|h]idden/, '') + 'visibilitychange';
      ...
      (a.flexAnimate = function (e, t, i, r, o) {
        if (
          ...
          if (p && r) {
            const l = $(a.vars.asNavFor).data('flexslider');
            if (
            ...
            s
              ...
              : (a.slides
                ...
                a.slides
                  .eq(e)
                  .css({ zIndex: 2 })
                  .animate({ opacity: 1 }, a.vars.animationSpeed, a.vars.easing, a.wrapup));
          else {
      ...
      (a.wrapup = function (e) {
        (v ||
          u ||
          (0 === a.currentSlide && a.animatingTo === a.last && a.vars.animationLoop
      ...
      (a.canAdvance = function (e, t) {
        const n = p ? a.pagingCount - 1 : a.last;
        return t
          ? !0
      ...
      (a.setProps = function (e, t, n) {
        let i = (function () {
          const n = e ? e : (a.itemW + a.vars.itemMargin) * a.move * a.animatingTo,
            i = (function () {
              if (u)
                return 'setTouch' === t
                  ? e
              ...
              (s
                ...
                : 0 == a.vars.fadeFirstSlide
                  ...
                  : a.slides
                      ...
                      .eq(a.currentSlide)
                      .css({ zIndex: 2 })
                      .animate({ opacity: 1 }, a.vars.animationSpeed, a.vars.easing)),
            a.vars.smoothHeight && m.smoothHeight());
        else {
          let t, i;
          ('init' === e &&
            ...
            a.vars.animationLoop &&
              ...
              a.container
                .append(
                  m.uniqueID(a.slides.first().clone().addClass('clone')).attr('aria-hidden', 'true')
                )
                .prepend(
                  m.uniqueID(a.slides.last().clone().addClass('clone')).attr('aria-hidden', 'true')
                )),
        ...
        (a.doMath(),
          ...
          a.vars.controlNav &&
            ...
            (('add' === t && !u) || a.pagingCount > a.controlNav.length
              ...
              : (('remove' === t && !u) || a.pagingCount < a.controlNav.length) &&
                (u && a.currentSlide > a.last && ((a.currentSlide -= 1), (a.animatingTo -= 1)),
      ...
      (a.removeSlide = function (e) {
        const t = isNaN(e) ? a.slides.index($(e)) : e;
        ((a.count -= 1),
          (a.last = a.count - 1),
          isNaN(e)
            ? $(e, a.slides).remove()
