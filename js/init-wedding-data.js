...
(function() {
    ...
    if (typeof WEDDING_DATA === 'undefined') {
        console.error('WEDDING_DATA not found! Make sure wedding-data.js is loaded before this script.');
        return;
    }
    ...
    function updateStructuredData() {
        const data = WEDDING_DATA;
        const mainEvent = data.events.find(e => e.isMainEvent) || data.events[data.events.length - 1];
